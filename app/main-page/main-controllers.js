...
app.controller('MainCtrl', ['ColorPicker', 'Html5LocalStorageTest', '$scope', '$timeout', 'prevScore', 'maxScore', function(ColorPicker, Html5LocalStorageTest, $scope, $timeout, prevScore, maxScore) {
